...
class Errors:
    ...
    @staticmethod
    @error_code_decorator
    def invalid_incident_field_in_layout(invalid_incident_fields):
        invalid_incident_fields = ', '.join(invalid_incident_fields)
        return f"The layout contains incident fields that do not exist in the content: {invalid_incident_fields}.\n" \
               "Please make sure:\n" \
               "1 - The right incident field is set and the spelling is correct.\n" \
               "2 - The id_set.json file is up to date. Delete the file by running: rm -rf Tests/id_set.json and" \
               " rerun the command."
